---
title: "The Six Criteria of Warrant"
description: "Quigley's working test for when an assertion counts as warranted, posted mid-bout and cited as precedent ever since."
tags: [wiki, concept]
type: concept
---
...
1. **Resolution** — does the claim resolve the problem that prompted the inquiry?
2. **Predictive success** — do its consequences hold up when tested?
3. **Coherence** — does it cohere with other warranted assertions?
4. **Public checkability** — can others run the test and get the same result?
5. **Survival** — has it faced the strongest objections and held?
6. **Fruitfulness** — does it open further inquiry?
