...
const GAMES: GameCard[] = [
  ...
  {
    href: "https://lissajous.subsurfaces.net",
    name: "Lissajous",
    blurb: "Harmonic space, sensory dissonance, and pitch-class geometry on ℤ/12ℤ. An interactive acoustic resonance visualizer, Euler Tonnetz lattice, and harmonic laboratory.",
    live: true,
    section: "featured",
    external: true,
  },
  {
    href: "https://pz.subsurfaces.net",
    name: "KNOX",
    blurb: "A second-screen co-op companion for Project Zomboid Build 42. A shared memory over Knox County: live run logs, item atlas, and tactical whiteboards.",
    live: true,
    section: "featured",
    external: true,
  },
