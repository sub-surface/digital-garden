...
export const CHAT_COMMANDS: { name: string; description: string; adminOnly?: boolean }[] = [
  ...
  { name: "debate",    description: "/debate <a> <b> [topic] — pit two scripted personas in a room" },
  { name: "ask",       description: "/ask <who> <question> — ask a philosopher a question" },
  { name: "yellowcard",description: "/yellowcard <username> [reason] — referee booking notice" },
  { name: "tape",      description: "/tape <a> <b> — Tale of the Tape matchup card" },
  { name: "philquote", description: "/philquote [author] — broadcast canonical philosophy quote" },
  { name: "bothelp",   description: "List available bot commands and personas" },
