  ...
  slots: [
    {
      ...
      count: [1, 1],
      motifKeys: ["orrery-rings", "chamber", "voxel-mass", "geometer", "lattice", "zodiac-wheel", "polyhedron", "sunburst", "waveform"],
      penRole: "structure",
      scale: [0.42, 0.52],
    },
    {
      ...
      count: [2, 4],
      motifKeys: ["instrument", "glyph-seal", "specimen-panel", "sunburst"],
      penRole: "highlight",
      scale: [0.09, 0.13],
    },
    {
